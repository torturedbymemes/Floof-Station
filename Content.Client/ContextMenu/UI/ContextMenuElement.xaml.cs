...
namespace Content.Client.ContextMenu.UI
{
    ...
    public partial class ContextMenuElement : ContainerButton
    {
        ...
        /// </summary>
        public virtual string Text { set => Label.SetMessage(FormattedMessage.FromMarkupPermissive(value.Trim()), ExamineSystem.SafeTags); } // Floof - prevent John Doe from injecting cmdlinks
